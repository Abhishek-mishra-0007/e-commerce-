...
<div class="container">
    <div class="forms-container">
        ...
        <div class="admin-login-form" style="display: none;">
         ...
         <!-- Seller Login Form -->
         <div class="seller-login-form" style="display: none;">
            <h2>Seller Login</h2>
            <form action="" method="POST">
                <div class="input-group">
                    <input type="email" name="email" placeholder="Email" required />
                ...
                <button type="submit" name="Seller_login" class="btn">Login as Seller</button>
                <p class="toggle-form">Go back to <span id="switch-to-user-login">User Login</span></p>
            </form>
        </div>
...
document.getElementById('switch-to-seller').addEventListener('click', function() {
    document.querySelector('.login-form').style.display = "none";
    document.querySelector('.seller-login-form').style.display = "block";
});
document.getElementById('switch-to-user-login').addEventListener('click', function() {
